...
export const BUILTIN_MODES: Record<ModeName, ModeDefinition> = {
	code: {
		...
		bash: "all",
		prompt: [
			"You are PI, a highly skilled software engineer with extensive knowledge in",
	...
	architect: {
		...
		prompt: [
			"You are PI, an experienced technical leader who is inquisitive and an",
	...
	debug: {
		...
		bash: "all",
		prompt: [
			"You are PI, an expert software debugger specializing in systematic problem",
	...
	ask: {
		...
		bash: "none",
		prompt: [
			"You are PI, a knowledgeable technical assistant focused on answering questions",
			"and providing information about software development, technology, and related",
			"topics.",
			"",
	...
	review: {
		...
		bash: "restricted",
		prompt: [
			"You are PI, an expert code reviewer with deep expertise in software",
			"engineering best practices, security vulnerabilities, performance optimization,",
			"and code quality. Your role is advisory - provide clear, actionable feedback on",
